...
def unzip_file(zip_path, scene_dir):
...
parser.add_argument("--SK_indoor_ids", nargs="+", type=int, default=[], help="A list of the ids of indoor videos to download")
parser.add_argument("--SK_outdoor_ids", nargs="+", type=int, default=[], help="A list of the ids of outdoor videos to download")
...
for dataset in args.datasets:
    if dataset == "SouthKensington":
        ...
        if args.InfinigenStereo_all == True:
            ...
            download_InfinigenStereo(output_directory, args.InfinigenStereo_images, args.InfinigenStereo_depths, args.InfinigenStereo_camviews, args.InfinigenStereo_videos, args.InfinigenStereo_specify_vid_ids, args.InfinigenStereo_vid_ids)

    elif dataset == "InfinigenSV":
        if args.InfinigenSV_all == True:
            download_InfinigenSV(output_directory, True, False, [])
        else:
            download_InfinigenSV(output_directory, args.InfinigenSV_vid_ids, args.InfinigenSV_specify_vid_ids, args.InfinigenSV_vid_ids)
